...
public class KnowledgeBase {
    ...
    private static HashMap<String, Function<Frame, Object>> ifNeeded = new HashMap<>();
    ...
    public static void register(String name, Function<Frame, Object> script) {ifNeeded.put(name, script);}
    ...
    public static Function<Frame, Object> retrieveIfNeeded(String name) {return ifNeeded.get(name);}
}
